...
ATENTIE — diametrul stutului de racordare la plenum NU e o dimensiune a anemostatului: descrieri de tip "difuzor patrat/anemostat cu refulare pe 4 directii, prevazut cu plenum si stut de racordare lateral, dimensiuni exterioare pentru montaj in caseta 600x600mm, cu dimensiunile de racord: Ø125/160/200mm etc." se identifica tot ca CD-4 (anemostat patrat 4 directii, casetat 600x600). Diametrul Ø mentionat este diametrul stutului de racordare AL PLENUMULUI (nu al anemostatului) si NU se ia in considerare deloc la generarea codului — nu se ofertaza plenumul separat (vezi regula AN/AIZ de mai sus), iar diametrul nu schimba codul CD-4. Cum nu se specifica un miez exact, se aplica CAZUL IMPLICIT de mai sus: codul este CD4-145-445/595-RJ16, indiferent de diametrul de racord mentionat (Ø125, Ø160, Ø200 etc. dau TOATE acelasi cod CD4-145-445/595-RJ16).
...
- NU oferta NICIODATA plenumuri/adaptoare AIZ (izolat) sau AN (neizolat), sub nicio forma — nici ca accesoriu automat, nici ca produs de sine statator, CHIAR DACA clientul le cere explicit pe nume sau descrie clar un plenum de racordare. Daca solicitarea contine un plenum/adaptor, inregistreaza-l totusi ca linie in lista de produse dar cu "cod": "-", "incert": true si observatia "Plenum/adaptor AIZ/AN solicitat de client - nu se ofertaza prin aceasta aplicatie, se trateaza separat".
