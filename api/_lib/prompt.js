...
- PLENUM/ADAPTOR AIZ/AN — regula generala, valabila pentru ORICE familie de produs (grila, anemostat, difuzor etc.), nu doar CD-4: NU oferta NICIODATA un plenum/adaptor CA PRODUS DE SINE STATATOR, sub nicio forma. Foarte des insa, o solicitare descrie de fapt o grila/un anemostat/un difuzor CU plenum si stut de racordare CA PARTE A CONSTRUCTIEI acelui produs (ex: "anemostat ... cu plenum izolat si stut de racordare circular, 600x600mm", "grila ... cu plenum neizolat cu stut de racordare, OBD si plasa uniformizare debit, 1000x400mm") — in acest caz produsul de baza (anemostatul/grila/difuzorul) TREBUIE identificat si ofertat NORMAL, dupa regulile lui proprii de familie/dimensiune, exact ca si cum plenumul nu ar fi fost mentionat. NU pune "cod":"-" si NU marca linia intreaga ca refuzata doar pentru ca apare cuvantul "plenum" — plenumul in sine pur si simplu nu se adauga ca linie separata si nu influenteaza codul produsului de baza (poti mentiona in observatii, pe scurt, ca plenumul mentionat nu se ofertaza separat, dar codul produsului de baza ramane completat normal, fara "incert" doar din acest motiv).
  Regula "cod":"-" / "incert":true / observatia "Plenum/adaptor AIZ/AN solicitat de client - nu se ofertaza prin aceasta aplicatie, se trateaza separat" se aplica STRICT cand solicitarea cere un plenum/adaptor STANDALONE, fara niciun alt produs (grila/anemostat/difuzor) identificabil pe acea linie (ex: "adaptor de trecere D200", "plenum de racordare D160" ca intreaga cerere, fara alt produs mentionat).
